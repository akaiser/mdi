...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1379: s => s.trimLeft(),
      _1380: s => s.trimRight(),
      _1381: (string, times) => string.repeat(times),
      _1382: Function.prototype.call.bind(String.prototype.indexOf),
      _1383: (s, p, i) => s.lastIndexOf(p, i),
      _1384: (string, token) => string.split(token),
      _1385: Object.is,
      _1386: o => o instanceof Array,
      _1391: a => a.pop(),
      _1392: (a, i) => a.splice(i, 1),
      _1393: (a, s) => a.join(s),
      _1394: (a, s, e) => a.slice(s, e),
      _1397: a => a.length,
      _1399: (a, i) => a[i],
      _1400: (a, i, v) => a[i] = v,
      _1402: o => {
      ...
      _1403: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1405: o => o instanceof Uint8Array,
      _1406: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1407: o => o instanceof Int8Array,
      _1408: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1409: o => o instanceof Uint8ClampedArray,
      _1410: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1411: o => o instanceof Uint16Array,
      _1412: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1413: o => o instanceof Int16Array,
      _1414: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1415: o => o instanceof Uint32Array,
      _1416: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1417: o => o instanceof Int32Array,
      _1418: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1420: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1421: o => o instanceof Float32Array,
      _1422: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1423: o => o instanceof Float64Array,
      _1424: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1425: (t, s) => t.set(s),
      _1427: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1429: o => o.buffer,
      _1430: o => o.byteOffset,
      _1431: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1432: (b, o) => new DataView(b, o),
      _1433: (b, o, l) => new DataView(b, o, l),
      _1434: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1435: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1436: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1437: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1438: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1439: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1440: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1441: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1442: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1443: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1444: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1445: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1448: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1449: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1450: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1451: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1452: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1453: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1466: (ms, c) =>
